...
import 'package:stylicai/Utills/companyname_screen.dart';
                        ...
                        InkWell(
                          onTap: () {
                            if (_nameformkey.currentState!.validate()) {
                             ...
                             signupController.saveLastName(lastNameController.text.trim());
                              Navigator.of(context).push(MaterialPageRoute(builder: (e) => CompanynameScreen()));
                            }
                          },
                          child: const Row(
                            children: [
